...
GLfloat position_cactus_grand_x = 400;
GLfloat position_cactus_petit_x = 800;
...
GLvoid Modelisation()
{
  ...
  glLightModelfv(GL_LIGHT_MODEL_AMBIENT, mipuissance);
	...
	if(position_y > 0 && position_y < 900) // ile 0 lobby
	{
		glPushMatrix(); // ile 0 lobby
		{
	...
	if(position_y > 1000 && position_y < 1700) // ILE 1 ROCHER TOMBER
	{
		glPushMatrix(); // ILE ROCHER TOMBER
		{
			...
			glPushMatrix(); //rocher gauche
			{
				...
				glRotatef(angle_rocher, 1,0,0);
				angle_rocher -= 10;
				position_y_rocher_gauche -= 3;
				position_z_rocher_gauche -= 3;
	...
	if(position_y > 2000 && position_y < 2500) // ile 2 dino
	{
		...
		glPushMatrix(); // petit cactus
		{
			...
			{
				position_cactus_petit_x = position_cactus_petit_x + 3;
		...
		glPushMatrix(); // grand cactus
		{
			...
			{
				position_cactus_grand_x = position_cactus_grand_x + 3;
	...
	if(position_y > 3000 && position_y < 3500) // ile 3 super simon
	{	
	...
	if (position_y < 0) // ile 4 animaux marins 
	{
		glPushMatrix(); //ile 4 aquatique
		{
	...
	if(position_y > 5000 && position_y < 5500) // ile 5 dark
	{
	...
	if(position_y > 6000 && position_y < 6500) // ile 6 TIC TAC TOE
	{
